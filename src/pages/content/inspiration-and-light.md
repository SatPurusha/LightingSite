...
{% scii "right", "Inspiration-1", "911 Memorial in Light" %}
...
{% scii "right", "Inspiration-2", "Darkness Holding the Light" %}
...
{% scii "right", "Inspiration-3", "Light Forms" %}
...
{% scii "right", "Inspiration-4", "Made of Light Book" %}
...
{% scii "right", "Inspiration-5", "Source" %}
